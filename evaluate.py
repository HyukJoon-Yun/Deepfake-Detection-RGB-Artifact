...
def build_model():
    ...
    model.classifier[0] = torch.nn.Dropout(p=0.4)
...
if __name__ == "__main__":
    print("=" * 60)
    print("EfficientNet-B4 RGB + Artifact Map Ensemble 평가")
    print("=" * 60)
    ...
    rgb_model_path = "models/rgb_model.ckpt"
    artifact_model_path = "models/artifact_map_model.ckpt"
